...
module.exports.AliExpressProductScrape = async function AliExpressProductScrape(productId, productPage) {
	const data = {};
	const productURL = `https://www.aliexpress.com/item/xxx/${productId}.html`;
	...
	return productDescription(descriptionSource)
		.then((response) => {
