...
router.get('/shipping-method', auth.isAuthenticated(), shippingMethodCtrl.shippingMethod);
router.get('/payment-method', auth.isAuthenticated(), paymentMethodCtrl.paymentMethod);
