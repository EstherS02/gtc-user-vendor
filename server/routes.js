...
export default function(app) {
    ...
    app.use('/terms-and-conditions', require('./hbs-routes/terms-and-cond'));
	...
	app.use('/privacy-policy', require('./hbs-routes/privacy-policy'));
	app.use('/support', require('./hbs-routes/support'));
